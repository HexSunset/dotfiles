...
vim.api.nvim_set_keymap('n', '<leader>n', ':BufferLineCycleNext<CR>', {nowait = true, silent=true})
vim.api.nvim_set_keymap('n', '<leader>p', ':BufferLineCyclePrev<CR>', {nowait = true, silent=true})
...
vim.api.nvim_set_keymap('n', '<leader>bg',
